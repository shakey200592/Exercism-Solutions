...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    is_eat_ghost_allowed = power_pellet_active and touching_ghost

    return is_eat_ghost_allowed
...
def score(touching_power_pellet, touching_dot):
    ...
    """
    has_player_scored = touching_power_pellet or touching_dot

    return has_player_scored
...
def lose(power_pellet_active, touching_ghost):
    ...
    has_player_lost = not power_pellet_active and touching_ghost
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    has_player_won = has_eaten_all_dots and not lose(
