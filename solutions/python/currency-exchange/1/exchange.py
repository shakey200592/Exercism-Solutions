...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread_as_decimal = spread / 100
    spread_amount = exchange_rate * spread_as_decimal
    effective_rate = spread_amount + exchange_rate
    value_of_exchanged_amount = budget / effective_rate
    number_of_bills = get_number_of_bills(value_of_exchanged_amount, denomination)
